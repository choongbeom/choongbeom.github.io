...
개인적인 견해로는 SPA는 싱글페이지 기준으로 되어 있는 것으로 예상된다. 즉, 한페이지 내에 여러개의 컴포넌트가 있을때 자원을 공유하는 개념으로 Vuex를 만들어서 사용한게 아닐까 싶다.  
그런데 페이지가 변경되니 또다른 싱글페이지가 생성되는 것으로 데이터가 초기화 된게 아닐까 하는게 나의 생각이다.  
