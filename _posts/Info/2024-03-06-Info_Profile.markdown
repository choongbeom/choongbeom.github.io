...
layout: post
title: Profile
date: 2024-03-06 16:30 +0900
category: INFO
---

**15년 차, 다양한 경험과 유연한 사고를 가진 개발자 김충범입니다.**
...
* **Introduce**
  ...
  15년간 자동화 기기(CD, ATM, 정산기) 및 장비 연동 시스템(사전투표 본인확인기, 스캐너 등)에 관련된 다양한 개발업무(설계/개발/유지보수)를 담당하였습니다.  
  스타트업 이커머스(라이트브라더스) 백엔드/프론트엔드 개발과 웹 솔루션 개발을 하였으며, 기획업무를 진행했던 경험이 있습니다.   
  다양한 고객사의 개발 업무를 통해 고객의 요구를 파악하는 방법과 이슈 발생 시 대처하는 많은 경험이 있습니다.  
...
본인인증, 신분증스캐너, 캐논스캐너, 코닥스캐너, 페이퍼리스, 이미징시스템 전문업체  
  ...
  * **개발파트 파트장**(2023.01-현재)
    - 선거관리 위원회 사전투표 신형 본인확인장비 소프트웨어부 개발

  * **솔루션 개발팀 매니저**(2022.01-2022.12)
    - ESG 웹솔루션 개발  
    - 특허관련 서비스 플랫폼 기획
    - 본인확인 인증시스템 유지보수 (아우디/벤틀리)

  * **클라우드 개발팀 매니저**(2021.07-2022.01)
    - 스타트업([라이트브라더스](https://wrightbrothers.kr/)) 웹사이트 개발
    - 신규 서비스 개발 (시세조회 - api/client/admin / Open되지 않음)  
