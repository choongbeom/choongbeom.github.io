...
* ### OSIV = true
![OSIV1](https://github.com/choongbeom/choongbeom.github.io/blob/dependabot/bundler/addressable-2.8.0/_posts/IMG/OSIV1.png?raw=true)  


* ### OSIV = false
![OSIV1](https://github.com/choongbeom/choongbeom.github.io/blob/dependabot/bundler/addressable-2.8.0/_posts/IMG/OSIV2.png?raw=true)  
...
### ※ 홍은모님 블로그에서 펌: [https://gracelove91.tistory.com/100](https://gracelove91.tistory.com/100)
